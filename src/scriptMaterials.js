...
//DoubleSide requires more resources when rendering, even though the side isn't visible. - used more gpu processing
...
//MeshLambertMaterial - much better for performance
...
//MeshPhysicalMaterial - same as standard material plus additional properties - worst in terms of performance!
...
// Iridecense - fuel puddle, soap bubbles, laser discs, etc
// material.iridescence = 1
// material.iridescenceIOR = 1
// material.iridescenceThicknessRange = [ 100, 800 ]

// gui.add(material, 'iridescence').min(0).max(1).step(0.0001)
// gui.add(material, 'iridescenceIOR').min(1).max(2.333).step(0.0001) // if below 1, will create unreal materials
// gui.add(material.iridescenceThicknessRange, '0').min(1).max(1000).step(1)
// gui.add(material.iridescenceThicknessRange, '1').min(1).max(1000).step(1)

// Transmission - to see through the materials
material.transmission = 1
material.ior = 1.5 // index of refraction - depends on the type of material being simulated
...
//PointsMaterial, ShaderMaterial, RawShaderMaterial
//Material can have drastic impact on performance
